...
SECRET_KEY = 'django-insecure-d*!y107rbyzjsq@-$onlt619+m59-0dw$1wu=ms_scmbv^yp$a'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["http://127.0.0.1", "127.0.0.1", "localhost"]
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1', 'http://127.0.0.1:8000', "http://localhost", "http://localhost:5173/api"]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = '50218e9edf13f1a9ad14c91877f8aadf'
EMAIL_HOST_PASSWORD = ''
